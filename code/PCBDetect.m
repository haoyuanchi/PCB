...
%     set(groot, 'CurrentFigure', drawback_show_handle);
    ...
    subplot(1,3,1);imshow(source_gary_box,[]);title('����ͼ��ֲ�');
    subplot(1,3,2);imshow(template_gary_box,[]);title('ģ��ͼ��ֲ�');
...
if issave ==1
    ...
    for drawback_idx=1:drawback_num_output
        ...
        subplot(1,3,1);imshow(drawback_info{drawback_idx}.source,[]);title('����ͼ��ֲ�');
        subplot(1,3,2);imshow(drawback_info{drawback_idx}.template,[]);title('ģ��ͼ��ֲ�');
        subplot(1,3,3);imshow(drawback_info{drawback_idx}.drawback,[]);title('��ͬ����');
        title(['ȱ�ݱ��:',num2str(drawback_idx)]);
...
%         drawback_fig=getimage(drawback_fig_handle); % ��ȡ���ϵ�е�ͼ���ļ����
%         imwrite(drawback_fig,[output_path,'drawback',num2str(drawback_idx),'_',drawback_info{drawback_idx}.type,'.bmp']);
        drawback_fig=frame2im(getframe(drawback_fig_handle)); % ��ȡ���ϵ�е�ͼ���ļ����
        imwrite(drawback_fig,[output_path,'drawback',num2str(drawback_idx),'_',drawback_info{drawback_idx}.type,'.bmp']);
    end
...
% result_fig=getimage(result_fig_handle); % ��ȡ���ϵ�е�ͼ���ļ����
% imwrite(result_fig,[output_path,'result','.bmp']);
% result_fig=frame2im(getframe(result_fig_handle)); % ��ȡ���ϵ�е�ͼ���ļ����
% imwrite(result_fig,[output_path,'result','.bmp']);
